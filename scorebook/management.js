(() => {
  ...
  function openOrderEditor(side){
    ...
    $(`input[name=orderSide][value="${side}"]`).checked=true;extraction=null;$("#extractionRows").innerHTML="";$("#imageWarnings").textContent="";$("#confirmOrder").disabled=true;$("#orderEditorTitle").textContent=side==="own"?"チームAのオーダー":"チームBのオーダー";panel.scrollTop=0;
  }
