(() => {
  ...
  function setup(){
    ...
    $("#restartOrderImport").onclick=()=>{$("#orderPanel").classList.remove("review-mode");reviewGuide.hidden=true;$("#extractionRows").innerHTML="";$("#confirmOrder").disabled=true;$("#orderPanel").scrollTo({top:0,behavior:"smooth"});};
