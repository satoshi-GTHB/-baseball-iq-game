(() => {
  ...
  function setup(){
    ...
    orderSteps.innerHTML="<li><b>① オーダー票を撮影</b>します（指示文は自動コピーされます）。</li><li><b>② 生成AIへ共有</b>を押し、画像を読める生成AIを選びます。</li><li>生成AIの入力欄で<b>貼り付け → 送信</b>します。</li><li>回答の<b>コピー</b>を押し、この画面へ戻ります。</li><li><b>③ 回答を取り込む</b>を押します。</li>";
    ...
    const shareButton=$("#shareOrderImage");shareButton.hidden=false;shareButton.disabled=true;shareButton.textContent="② 生成AIへ共有";
