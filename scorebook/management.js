(() => {
  ...
  function setup(){
    ...
    document.querySelectorAll("[data-open-panel]").forEach(b=>b.onclick=()=>b.dataset.openPanel==="orderPanel"?openOrderHub():showPanel(b.dataset.openPanel)); document.querySelectorAll("[data-close-panel]").forEach(b=>b.onclick=()=>showPanel(null));
