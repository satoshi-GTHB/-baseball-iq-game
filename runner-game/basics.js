...
subTabs.forEach(b=>b.addEventListener("click",()=>requestAnimationFrame(()=>document.querySelector("#"+b.dataset.sub+" .sub-title").scrollIntoView({behavior:"instant",block:"start"}))));
